...
jQuery(document).ready(function($) {
	...
	function hide_statuses() {
		$('#format-aside,#format-chat,#format-gallery,#format-image,#format-link,#format-quote,#format-status,#format-video').hide();
	}
	...
	if($("#post-formats-select").length) {
		...
		var post_formats = ['aside','chat','gallery','image','link','quote','status','video'];
